...
from real_scraper import RealInternshipScraper
import json
import threading
import time
...
@app.route('/')
def index():
    return render_template('real_search_interface.html')
...
def search_internships():
    ...
    thread = threading.Thread(target=perform_search, args=(keywords, location, job_type, experience, sources))
    thread.start()
...
def perform_search(keywords, location, job_type, experience, sources):
    global search_results, search_in_progress
